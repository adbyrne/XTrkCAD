        ...
        void 	*data)
{
	...
	g_signal_connect(G_OBJECT(b->widget), "preedit-changed",
	                 G_CALLBACK(stringPreeditChanged), b);
	g_signal_connect(G_OBJECT(b->widget), "focus-out-event",
	                 G_CALLBACK(stringFocusOutEvent), b);
	g_signal_connect(G_OBJECT(b->widget), "focus-in-event",
	                 G_CALLBACK(stringFocusInEvent), b);
	g_signal_connect(G_OBJECT(b->widget), "leave-notify-event",
	                 G_CALLBACK(stringLeaveNotifyEvent), b);
	g_signal_connect(G_OBJECT(b->widget), "event", G_CALLBACK(stringEvent), b);
	g_signal_connect(G_OBJECT(b->widget), "event-after",
	                 G_CALLBACK(stringEventAfter), b);
	g_signal_connect(G_OBJECT(b->widget), "key-press-event",
	                 G_CALLBACK(stringKeyPressEvent), b);
	g_signal_connect(G_OBJECT(b->widget), "state-changed",
	                 G_CALLBACK(stringStateChanged), b);
	g_signal_connect(G_OBJECT(b->widget), "activate", G_CALLBACK(stringActivate),
	                 b);
