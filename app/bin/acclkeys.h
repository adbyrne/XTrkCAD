...
#define ACCL_DRAWDIMLINE		(WCTL+WSHIFT+'2')
...
#define ACCL_REPORTSUNCONN	(WALT+WCTL+'o')
#define ACCL_REPORTSTURNOUT	(0)
#define ACCL_REPORTSTRACKLEN	(0)
#define ACCL_REPORTSCURVESTATS	(0)
#define ACCL_REPORTSEQUIPMENT	(0)
#define ACCL_REPORTSGAPS	(0)
#define ACCL_REPORTSKINKED	(0)
#define ACCL_REPORTSNOTES	(0)
...
#define ACCL_IMPORT_DXF	(0)
#define ACCL_EXPORTDXF	(0)
#define ACCL_EXPORTSVG	(0)
#define ACCL_PRINTEXPORTFILTER	(0)
...
#define ACCL_LAYERGROUPS	(WALT+WCTL+'j')
#define ACCL_MANAGENOTES	(WALT+WCTL+'z')
