...
/*2*/ { PD_STRING, switchmotorUnlocked, "unlocked", PDO_NOPREF|PDO_STRINGLIMITLENGTH, (void*)350, N_("Unlocked"), 0, 0, sizeof(switchmotorUnlocked)},
/*3*/ { PD_STRING, switchmotorLocked, "locked", PDO_NOPREF | PDO_STRINGLIMITLENGTH, (void*)350, N_("Locked"), 0, 0, sizeof(switchmotorLocked)},
};
...
static paramData_t switchmotorEditPLs[] = {
    /*0*/ { PD_STRING, switchmotorEditName, "name", PDO_NOPREF | PDO_STRINGLIMITLENGTH,
	    (void*)200, N_("Name"), 0, 0, sizeof(switchmotorEditName)},
    ...
    /*2*/ { PD_STRING, switchmotorEditUnlocked, "unlocked", PDO_NOPREF | PDO_STRINGLIMITLENGTH,
	    (void*)350, N_("Unlocked"), 0, 0, sizeof(switchmotorEditUnlocked)},
    /*3*/ { PD_STRING, switchmotorEditLocked, "locked", PDO_NOPREF | PDO_STRINGLIMITLENGTH,
	    (void*)350, N_("Locked"), 0, 0, sizeof(switchmotorEditLocked)},
...
static paramData_t smotorEditPLs[] = {
    /*0*/ { PD_STRING, smotorEditName, "name", PDO_NOPREF|PDO_STRINGLIMITLENGTH,
	    (void*)200,  N_("Name"), 0, 0, sizeof(smotorEditName)},
    /*1*/ { PD_STRING, smotorEditScript, "script", PDO_NOPREF|PDO_STRINGLIMITLENGTH,
	    (void*)350, N_("Script"), 0, 0, sizeof(smotorEditScript)},
};
