...
#define I_STRING_0		I_LONG_N
	{ PD_STRING, NULL, "S1", PDO_NOPREF, I2VP(30) },
	{ PD_STRING, NULL, "S2", PDO_NOPREF, I2VP(30) },
	{ PD_STRING, NULL, "S3", PDO_NOPREF, I2VP(30) },
	{ PD_STRING, NULL, "S4", PDO_NOPREF, I2VP(30) },
#define I_STRING_N		I_STRING_0+4

#define I_LAYER_0		I_STRING_N
	{ PD_COMBOLIST, NULL, "Y1", PDO_NOPREF, I2VP(150), NULL, 0 },
#define I_LAYER_N		I_LAYER_0+1

#define I_COLOR_0		I_LAYER_N
	{ PD_COLORLIST, NULL, "C1", PDO_NOPREF, NULL, N_("Color"), BC_HORIZONTAL|BC_NOBORDER },
	{ PD_COLORLIST, NULL, "C2", PDO_NOPREF, NULL, N_("Color"), BC_HORIZONTAL|BC_NOBORDER },
#define I_COLOR_N		I_COLOR_0+2

#define I_LIST_0		I_COLOR_N
	{ PD_COMBOLIST, NULL, "L1", PDO_NOPREF, I2VP(150), NULL, 0 },
	{ PD_COMBOLIST, NULL, "L2", PDO_NOPREF, I2VP(150), NULL, 0 },
	{ PD_COMBOLIST, NULL, "L3", PDO_NOPREF, I2VP(150), NULL, 0 },
	{ PD_COMBOLIST, NULL, "L4", PDO_NOPREF, I2VP(150), NULL, 0 },
#define I_LIST_N		I_LIST_0+4

#define I_EDITLIST_0	I_LIST_N
	{ PD_COMBOLIST, NULL, "LE1", PDO_NOPREF, I2VP(150), NULL, BL_EDITABLE },
...
#define I_PIVOT_0		I_TEXT_N
	{ PD_RADIO, NULL, "P1", PDO_NOPREF, pivotLabels, N_("Lock"), BC_HORIZONTAL|BC_NOBORDER, 0 },
#define I_PIVOT_N		I_PIVOT_0+1

#define I_TOGGLE_0      I_PIVOT_N
	{ PD_TOGGLE, NULL, "boxed1", PDO_NOPREF|PDO_DLGHORZ, boxLabels, N_("Boxed"), BC_HORIZONTAL|BC_NOBORDER },
	{ PD_TOGGLE, NULL, "boxed2", PDO_NOPREF|PDO_DLGHORZ, boxLabels, N_("Boxed"), BC_HORIZONTAL|BC_NOBORDER },
	{ PD_TOGGLE, NULL, "boxed3", PDO_NOPREF|PDO_DLGHORZ, boxLabels, N_("Boxed"), BC_HORIZONTAL|BC_NOBORDER },
	{ PD_TOGGLE, NULL, "boxed4", PDO_NOPREF|PDO_DLGHORZ, boxLabels, N_("Boxed"), BC_HORIZONTAL|BC_NOBORDER },
...
static struct {
	...
	/*LAYER*/		{ PD_COMBOLIST,PDO_LISTINDEX,	   I_LAYER_0, I_LAYER_N },
	/*STRING*/		{ PD_STRING,0,		   I_STRING_0, I_STRING_N },
	/*TEXT*/		{ PD_TEXT,	PDO_DLGNOLABELALIGN, I_TEXT_0, I_TEXT_N },
	/*LIST*/		{ PD_COMBOLIST, PDO_LISTINDEX,	   I_LIST_0, I_LIST_N },
	/*EDITABLELIST*/{ PD_COMBOLIST, 0,	   I_EDITLIST_0, I_EDITLIST_N },
