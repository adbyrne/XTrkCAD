...
create_mainwin(plate_edit *p)
{
	...
	gtk_widget_show(menuitem);
	gtk_menu_set_accel_group(GTK_MENU(menu), ag);
	p->undo_me = add_menuitem(menu, "Undo", (GtkSignalFunc)undo_func, data, ag,
	                          "<ctrl>Z");
	p->redo_me = add_menuitem(menu, "Redo", (GtkSignalFunc)redo_func, data, ag,
	                          "<ctrl>Y");
	set_undo_state(p, NULL, NULL);
	add_menuitem(menu, "Toggle Corner", (GtkSignalFunc)toggle_corner_func, data, ag,
	             "<ctrl>T");
	add_menuitem(menu, "Delete Point", (GtkSignalFunc)delete_pt_func, data, ag,
	             "<ctrl>D");
	add_menuitem(menu, "Selection Mode", (GtkSignalFunc)set_select_mode_func, data,
	             ag, "1");
	add_menuitem(menu, "Add Curve Mode", (GtkSignalFunc)set_curve_mode_func, data,
	             ag, "2");
	add_menuitem(menu, "Add Corner Mode", (GtkSignalFunc)set_corner_mode_func, data,
	             ag, "3");
	add_menuitem(menu, "Add Left Mode", (GtkSignalFunc)set_left_mode_func, data, ag,
	             "4");
	add_menuitem(menu, "Add Right Mode", (GtkSignalFunc)set_right_mode_func, data,
	             ag, "5");
	add_menuitem(menu, "Add Cornu Mode", (GtkSignalFunc)set_cornu_mode_func, data,
	             ag, "6");
