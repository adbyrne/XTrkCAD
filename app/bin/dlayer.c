...
#define I_COUNT (11)
    { PD_MESSAGE, N_("Object Count:"), "count", PDO_DLGBOXEND|PDO_DLGNOLABELALIGN, (void *)370 },
    { PD_MESSAGE, N_("All Layer Preferences"), "prefs", PDO_DLGRESETMARGIN, (void *)180 },
    ...
    for (int i = 0; i<NUM_LAYERS; i++) {
        ...
        if (i<NUM_BUTTONS) {
            ...
            layer_btns[i] = wButtonCreateForToolbar(mainW, 0, 0, message,
                                          ...
                                          BO_ICON|BO_TOOLBAR, 0, (wButtonCallBack_p)FlipLayer, (void*)(uintptr_t)i);
            /* add the help text */
