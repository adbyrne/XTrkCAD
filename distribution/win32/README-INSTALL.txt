XTrkCAD Installation — Windows
================================

This archive is a self-contained XTrkCAD build. All required GTK3
runtime libraries are bundled — no separate installation is needed.
...
SMARTSCREEN WARNING
-------------------
Windows may show a SmartScreen warning because this build is not
signed with a commercial code-signing certificate. To proceed:
