...
#define wDropListCreate wComboListCreate
#define wWinPopupCreate(w, r, b, h, t, n, o, p, g) wWinDialogCreate(w, h, t, n, o, p, g)
...
EXPORT void ParamLoadMessageOrig(
        paramGroup_p pg,
        int inx,
        char * message )
{
...
EXPORT void ParamLoadControlOrig(
        paramGroup_p pg,
        int inx )
{
	paramData_p p = &pg->paramPtr[inx];
...
*/
EXPORT void ParamLoadControlsOrig(
        paramGroup_p pg )
{
	int inx;
...
EXPORT void ParamRegisterOrig( paramGroup_p pg )
{
	paramData_t * p;
	const char * cp;
	WDOUBLE_T tmpR;
...
EXPORT void ParamUpdatePrefsOrig( void )
{
	int inx;
	paramGroup_p pg;
	paramData_p p;
...
EXPORT void ParamGroupRecordOrig(
        paramGroup_p pg )
{
	paramData_p p;
	long rgb;
...
EXPORT void ParamStartRecordOrig( FILE *macroFile )
{
	int inx;
	paramGroup_p pg;
...
EXPORT void ParamRestoreAllOrig( void )
{
	int inx;
	paramGroup_p pg;
...
EXPORT void ParamSaveAllOrig( void )
{
	int inx;
...
EXPORT void ParamMenuPushOrig( void * dp )
{
	paramData_p p = (paramData_p)dp;
...
EXPORT wBool_t ParamCheckInputsOrig(
        paramGroup_p group,
        wControl_p b )
{
...
EXPORT void ParamResetInvalidOrig(
        wWin_p win )
{
...
EXPORT void ParamControlShowOrig( paramGroup_p pg, wIndex_t inx, wBool_t bShow )
{
	paramData_p p = &pg->paramPtr[inx];
 ...
 */
void
ParamSetInPlaybackOrig(bool state, long delay)
{
	paramPlayback = state;
	paramDelay = delay;
}
...
EXPORT void
ParamSetInReadTracksOrig(bool state)
{
	bInReadTracks = state;
}

EXPORT void
ParamTurnOffDelaysOrig(bool disable)
{
...
*
*/
EXPORT void ParamLayoutDialogOrig(
        paramGroup_p pg )
{
	wWinPix_t w, h;
...
EXPORT void ParamDialogOkActiveOrig(
        paramGroup_p pg,
        int active )
{
	if ( pg->okB ) {
...
EXPORT void ParamCreateControlsOrig(
        paramGroup_p pg,
        paramChangeProc changeProc )
{
	paramData_p pd;
...
EXPORT void ParamInitOrig( void )
{
