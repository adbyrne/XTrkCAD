...
wWin_p wMain( int argc, char * argv[] )
{
	...
	mainW = wWinMainCreate( "Fred", 2, 2, "Help", "Main", F_AUTOSIZE|F_MENUBAR,
	                        NULL, NULL );
	...
	butt2 = wButtonCreate( mainW, 100, 0, "Button2", (char*)fred_bmp,
	                       BO_ICON|BB_CANCEL, 0, doButt2, NULL );
	wButtonCreate( mainW, -1, 0, "Button2", (char*)fred_bmp, BO_ICON, 0, doButt2,
	               NULL );
	wButtonCreate( mainW, -1, 0, "Button2", (char*)fred_bmp, BO_ICON, 0, doButt2,
	               NULL );
	wButtonCreate( mainW, -1, 0, "Button2", (char*)fred_bmp, BO_ICON, 0, doButt2,
	...
	wIntegerCreate( mainW, 50, -1, "Integer1", "Int1", 0, 50, -100, 100, &valInt1,
	                doInt1, NULL );
	wFloatCreate( mainW, 50, -1, "Float1", "Flt1", 0, 50, -100, 100, &valFlt1,
	              doFlt1, NULL );
	wStringCreate( mainW, 50, -1, "Text1", "Txt1", 0, 100, valTxt1, sizeof valTxt1,
	               doTxt1, NULL );
	...
	list1B = wListCreate( mainW, 250, -4, "List1", NULL, 0, 10, 200, &valList1,
	                      doList1, NULL );
	populateList( list1B );
	list2B = wDropListCreate( mainW, 250, -4, "List2", NULL, 0, 10, 200, &valList2,
	                          doList2, NULL );
	populateList( list2B );
	list3B = wComboListCreate( mainW, 250, -4, "List3", NULL, 0, 10, 200, &valList3,
	                           doList3, NULL );
	populateList( list3B );
