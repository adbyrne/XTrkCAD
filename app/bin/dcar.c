...
#define D                       (C+9)
#define I_CD_MSG                (D+0)
	{ PD_MESSAGE, NULL, "mess1", PDO_DLGNOLABELALIGN|PDO_DLGRESETMARGIN|PDO_DLGBOXEND, I2VP(450) },
#define I_CD_NEW                (D+1)
...
static void DoCarPartDlg( carDlgAction_e *actions )
{
	...
	if ( carDlgPG.win == NULL ) {
		ParamCreateDialog( &carDlgPG, MakeWindowTitle(_("New Car Part")), _("Add"), CarDlgOk, CarDlgClose, TRUE, CarDlgLayout, F_USETEMPLATE|F_BLOCK|F_RESIZE|F_RECALLSIZE|PD_F_ALT_CANCELLABEL, CarDlgUpdate );
...
static paramGroup_t carInvPG = { "carinv", PGO_DIALOGTEMPLATE, carInvPLs, COUNT( carInvPLs ) };
