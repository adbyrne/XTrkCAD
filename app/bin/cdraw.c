...
/*PP*/  { DESC_POS, N_("First Point: X,Y"), &drawData.endPt[0], "firstpt" },
/*CE*/	{ DESC_POS, N_("Center: X,Y"), &drawData.center, "center" },
/*AL*/	{ DESC_FLOAT, N_("Angular Length"), &drawData.angle, "angularlength" },
/*LA*/  { DESC_FLOAT, N_("Line Angle"), &drawData.angle, "lineangle" },
/*A1*/	{ DESC_ANGLE, N_("CCW Angle"), &drawData.angle0, "ccwangle" },
/*A2*/	{ DESC_ANGLE, N_("CW Angle"), &drawData.angle1, "cwangle" },
/*RD*/	{ DESC_DIM, N_("Radius"), &drawData.radius, "radius" },
...
/*LT*/  { DESC_LIST, N_("Line Type"), &drawData.lineType, "linetype" },
/*CO*/	{ DESC_COLOR, N_("Color"), &drawData.color, "color" },
/*FL*/	{ DESC_BOXED, N_("Filled"), &drawData.filled, "filled" },
/*OP*/  { DESC_BOXED, N_("Open End"), &drawData.open, "open" },
/*BX*/  { DESC_BOXED, N_("Boxed"), &drawData.boxed, "boxed" },
/*BE*/	{ DESC_LIST, N_("Lumber"), &drawData.benchChoice, "lumber" },
/*OR*/	{ DESC_LIST, N_("Orientation"), &drawData.benchOrient, "orient" },
/*DS*/	{ DESC_LIST, N_("Size"), &drawData.dimenSize, "size" },
/*TP*/	{ DESC_POS, N_("Text Origin: X,Y"), &drawData.endPt[0], "textorig" },
/*TA*/	{ DESC_FLOAT, N_("Text Angle"), &drawData.angle, "text-angle" },
/*TS*/	{ DESC_EDITABLELIST, N_("Font Size"), &drawData.fontSizeInx, "fontsize" },
/*TX*/	{ DESC_TEXT, N_("Text"), &drawData.text, "text" },
/*LK*/  { DESC_BOXED, N_("Lock To Origin"), &drawData.lock_origin, "lock"},
/*OI*/  { DESC_POS, N_("Rot Origin: X,Y"), &drawData.origin, "rotorigin" },
/*RA*/  { DESC_FLOAT, N_("Rotate By"), &drawData.rotate_angle, "rotangle" },
