/** \file dprintexportfilter.c
 * Shared "Filter Layers/Groups..." scope for Print and DXF/SVG export
 * (SF #789, Layer Groups phase 2). See dprintexportfilter.h.
 */
...
reportsFilter_t printExportFilter;

void DoPrintExportFilter(void *unused)
{
	ShowReportsFilterDialog(&printExportFilter);
}
