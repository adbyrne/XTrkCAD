...
/*0*/ { PD_STRING, switchmotorName, "name", PDO_NOPREF|PDO_NOTBLANK|PDO_STRINGLIMITLENGTH, I2VP(200), N_("Name"), 0, 0, sizeof(switchmotorName)},
...
static paramData_t switchmotorEditPLs[] = {
    /*0*/ { PD_STRING, switchmotorEditName, "name", PDO_NOPREF | PDO_NOTBLANK | PDO_STRINGLIMITLENGTH, I2VP(200), N_("Name"), 0, 0, sizeof(switchmotorEditName)},
