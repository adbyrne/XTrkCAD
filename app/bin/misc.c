...
static paramData_t rotatePLs[] = { { PD_FLOAT, &rotateValue, "rotate", PDO_ANGLE|PDO_NORECORD,
		&rn360_360, N_("Angle:") } };
...
static paramData_t indexPLs[] = { { PD_STRING, &trackIndex, "select",
		PDO_NOPREF|PDO_NORECORD|PDO_STRINGLIMITLENGTH, (void*)STR_SIZE-1, N_("Indexes:"), 0, 0, sizeof trackIndex } };
static paramGroup_t indexPG = { "index", 0, indexPLs, sizeof indexPLs
		/ sizeof indexPLs[0] };

static paramFloatRange_t r_1000_1000 = { -1000.0, 1000.0, 80 };
static void MoveEnterOk(void *);
static paramData_t movePLs[] = { { PD_FLOAT, &moveValue.x, "moveX", PDO_DIM|PDO_NORECORD,
		&r_1000_1000, N_("Move X:") }, { PD_FLOAT, &moveValue.y, "moveY",
		PDO_DIM|PDO_NORECORD, &r_1000_1000, N_("Move Y:") } };
