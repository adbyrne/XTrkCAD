...
{
	wIcon_p icon;
	icon = CreateToolbarIconFromResource("ties.png");
...
{
	wIcon_p icon;
	icon = CreateToolbarIconFromResource( "tunnel.png");
...
{
	wIcon_p icon;
	icon = CreateToolbarIconFromResource( "bridge.png");
...
{
	wIcon_p icon;
	icon = CreateToolbarIconFromResource( "roadbed.png");
